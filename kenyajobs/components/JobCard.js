...
export default function JobCard({ job }) {
  ...
  const location = job.candidate_required_location || job.job_city || job.location?.display_name || "Worldwide";
      ...
      <div>
        ...
        <div className="flex items-start gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-600 font-medium mt-0.5">{company}</p>
          </div>
        </div>
